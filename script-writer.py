...
ideation_prompt_template = ChatPromptTemplate.from_template(ideation_prompt_template_text)
...
SCRIPT_PROMPT_TEMPLATE = ChatPromptTemplate.from_template(SCRIPT_PROMPT_TEMPLATE_TEXT)
